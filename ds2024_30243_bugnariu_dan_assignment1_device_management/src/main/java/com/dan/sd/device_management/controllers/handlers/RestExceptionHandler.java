package com.dan.sd.device_management.controllers.handlers;

import com.dan.sd.device_management.controllers.handlers.exceptions.model.*;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {ResourceNotFoundException.class, DuplicateResourceException.class, EntityValidationException.class, AuthIncorrectCredentialsException.class})
